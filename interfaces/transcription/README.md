...
Starter applications implementing this interface at a minimum should pass the [conformance tests](./test/test.conformance.js). These conformance tests validate that your minimal starter app correctly implements the STT scaffolding contract.
...
BASE_URL=https://my-stt-app.vercel.app pnpm run test:transcription
```
