...
# Usage: ./tests/run-transcription-app.sh [test-type]
...
echo "Running Transcription test harness for: $TEST_TYPE"
echo "====================================================="
...
# Run the Transcription server in background
echo "Starting Transcription server..."
python3 tests/transcription/server.py &
SERVER_PID=$!
