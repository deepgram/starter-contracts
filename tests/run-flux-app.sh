...
# Run Flux test harness
# This script is designed to be run from a starter app directory (e.g., node-flux)
...
#
# Usage: ./contracts/tests/run-flux-app.sh
...
echo "✅ App is running"
echo ""
echo "Running Flux test harness"
echo "====================================================="
...
if ./contracts/tests/flux/structure/validate-contracts.sh "$REPO_ROOT"; then
...
if ./contracts/tests/flux/structure/validate-frontend.sh "$REPO_ROOT"; then
...
if npx playwright test tests/flux/ui/workflow.spec.js; then
