...
# Run Live Transcription test harness
# This script is designed to be run from a starter app directory (e.g., node-live-transcription)
...
#
# Usage: ./contracts/tests/run-live-transcription-app.sh
...
echo "✅ App is running"
echo ""
echo "Running Live Transcription test harness"
echo "====================================================="
...
if ./contracts/tests/live-transcription/structure/validate-contracts.sh "$REPO_ROOT"; then
...
if ./contracts/tests/live-transcription/structure/validate-frontend.sh "$REPO_ROOT"; then
...
if npm run test:live-transcription -- tests/live-transcription/api/; then
...
if npx playwright test tests/live-transcription/ui/workflow.spec.js; then
