...
# Run Live Text-to-Speech test harness
# This script is designed to be run from a starter app directory (e.g., node-live-text-to-speech)
...
#
# Usage: ./contracts/tests/run-live-text-to-speech-app.sh
...
echo "✅ App is running"
echo ""
echo "Running Live Text-to-Speech test harness"
echo "====================================================="
...
if ./contracts/tests/live-text-to-speech/structure/validate-contracts.sh "$REPO_ROOT"; then
...
if ./contracts/tests/live-text-to-speech/structure/validate-frontend.sh "$REPO_ROOT"; then
...
if npx playwright test tests/live-text-to-speech/ui/workflow.spec.js; then
